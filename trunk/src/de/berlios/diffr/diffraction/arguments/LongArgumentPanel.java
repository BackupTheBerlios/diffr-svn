...
public class LongArgumentPanel extends ArgumentPanel {
  private LongArgumentPanel() {}
  private ArgumentType argument;
  private JTextField text = new JTextField();
  public LongArgumentPanel(ArgumentType p, Object object) {
    this.argument = p;
    this.setLayout(new BoxLayout(this, BoxLayout.X_AXIS));
    this.add(new JLabel(p.getHint() + " (Long) "));
